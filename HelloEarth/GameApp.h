...
private:
	...
	Graphics::VertexShader mDepthVertexShader;
	Graphics::PixelShader mDepthPixelShader;
	Graphics::TypedConstantBuffer<DepthCB> mDepthBuffer;
	Graphics::Sampler mPointSampler;
