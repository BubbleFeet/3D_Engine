...
namespace
{
	...
	{
		{ Math::Vector3(-0.5f, 0.5f, 0.0f), Math::Colors::Red },
		{ Math::Vector3(0.5f, 0.5f, 0.0f), Math::Colors::Blue },
		{ Math::Vector3(-0.5f, -0.5f, 0.0f), Math::Colors::Green },
		{ Math::Vector3(0.5f, -0.5f, 0.0f), Math::Colors::Magenta },
	};
...
void GameApp::OnUpdate()
{
	...
	Graphics::GraphicsSystem::Get()->BeginRender(Math::Colors::Grey);
